...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="max-w-ember mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden text-neutral-9"
            ...
            <div className="flex flex-col space-y-3">
              {navItems.map((item) => (
                <Link
                  key={item.name}
                  to={item.path}
                  className="font-medium text-neutral-9 hover:text-accent"
